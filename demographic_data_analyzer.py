...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(100 * len(higher_education[higher_education["salary"]==">50K"])/len(higher_education["salary"]), 1)
    lower_education_rich = round(100 * len(lower_education[lower_education["salary"]==">50K"])/len(lower_education["salary"]), 1)
